...
"border-radius: 4px;")
        ...
        self.spinRelInt = QtWidgets.QDoubleSpinBox(self.tab)
        self.spinRelInt.setGeometry(QtCore.QRect(610, 659, 81, 22))
        self.spinRelInt.setDecimals(3)
        self.spinRelInt.setMinimum(0.01)
        self.spinRelInt.setMaximum(0.9)
        self.spinRelInt.setSingleStep(0.04)
        self.spinRelInt.setProperty("value", 0.5)
        self.spinRelInt.setObjectName("spinRelInt")
